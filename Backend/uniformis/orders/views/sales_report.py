...
class SalesReportViewSet(viewsets.ViewSet):
    ...
    def get_report_data(self, start_date, end_date):
        ...
        # Calculate cancelled and refunded amounts
        ...
        # Only count refunds that have been processed
        ...
        # Get daily sales trend with refund information
        ...
        # Add refund information to daily trend
        for day in daily_sales:
            day_refunds = OrderItem.objects.filter(
                order__in=orders,
                status__in=['cancelled', 'returned'],
                refund_processed=True,
