        ...
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
          ...
          {addressToDelete && (
            <div className="bg-gray-50 p-3 rounded mb-4 text-sm">
              <p><strong>{addressToDelete.name}</strong> ({addressToDelete.address_type})</p>
              <p>{addressToDelete.house_no}</p>
              {addressToDelete.landmark && <p>{addressToDelete.landmark}</p>}
              <p>{`${addressToDelete.city}, ${addressToDelete.state} - ${addressToDelete.pin_code}`}</p>
            </div>
          )}
          ...
          <div key={address.id} className="bg-white p-4 rounded-lg shadow-md">
            <div className="flex justify-between items-start mb-2">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => openDeleteModal(address)} className="text-red-600 hover:text-red-800">
                  Delete
                </button>
              </div>
            </div>
